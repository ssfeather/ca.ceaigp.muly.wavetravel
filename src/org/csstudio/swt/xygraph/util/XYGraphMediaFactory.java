...
public final class XYGraphMediaFactory
{
	...
	{
		if (CURSOR_GRABBING != null && !CURSOR_GRABBING.isDisposed()) CURSOR_GRABBING.dispose();
		if (cursorRegistry != null) for (Cursor cursor : cursorRegistry)
		{
			if (cursor != null && !cursor.isDisposed()) cursor.dispose();
		}
	...
	{
		// FIXME Die default Schriftart bzw. Schriftgrï¿½ï¿½e hï¿?gt vom
		// Betriebssystem ab
